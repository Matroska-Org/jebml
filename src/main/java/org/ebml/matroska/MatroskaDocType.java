...
/**
 * DocType for Matroska files. This has all the element type id declares and also is in charge of creating the correct element classes from the type
 * id.
 */
public class MatroskaDocType implements DocType
{
  ...
  static public byte[] TrackFlagEnabled_Id = {(byte) 0xB9 };
  static public byte[] TrackFlagDefault_Id = {(byte) 0x88 };
  static public byte[] TrackFlagForced_Id = {0x55, (byte) 0xAA };
  static public byte[] TrackFlagLacing_Id = {(byte) 0x9C };
  static public byte[] TrackMinCache_Id = {0x6D, (byte) 0xE7 };
  static public byte[] TrackMaxCache_Id = {0x6D, (byte) 0xF8 };
  static public byte[] TrackDefaultDuration_Id = {0x23, (byte) 0xE3, (byte) 0x83 };
  static public byte[] TrackMaxBlockAdditionID_Id = {0x55, (byte) 0xEE };
  ...
  static public byte[] TrackCodecDecodeAll_Id = {(byte) 0xAA };
  static public byte[] TrackSeekPreroll_Id = {(byte) 0x56, (byte) 0xBB };
  ...
  static public byte track_subtitle = 0x11; // /< Text-subtitles. One track contains one language and only one track can be active (player-side
                                            // configuration)
   ...
   */
  static public String TrackTypeToString(final byte trackType)
  {
  ...
  protected void init()
  {
    try
    {
      final ElementType baseLevel = new ElementType("", (short) 0, (byte[]) null,
      ...
      level3 = new ElementType("TrackFlagEnabled",
                               (short) 3,
                               TrackFlagEnabled_Id,
                               ElementType.UINTEGER_ELEMENT,
                               (ArrayList<ElementType>) null);
      ...
      level3 = new ElementType("TrackFlagDefault",
                               (short) 3,
                               TrackFlagDefault_Id,
                               ElementType.UINTEGER_ELEMENT,
                               (ArrayList<ElementType>) null);
      ...
      level3 = new ElementType("TrackFlagForced",
                               (short) 3,
                               TrackFlagForced_Id,
                               ElementType.UINTEGER_ELEMENT,
                               (ArrayList<ElementType>) null);
      ...
      level3 = new ElementType("TrackMinCache",
                               (short) 3,
                               TrackMinCache_Id,
                               ElementType.UINTEGER_ELEMENT,
                               (ArrayList<ElementType>) null);
      ...
      level3 = new ElementType("TrackMaxCache",
                               (short) 3,
                               TrackMaxCache_Id,
                               ElementType.UINTEGER_ELEMENT,
                               (ArrayList<ElementType>) null);
      ...
      level3 = new ElementType("TrackMaxBlockAdditionID",
                               (short) 3,
                               TrackMaxBlockAdditionID_Id,
                               ElementType.UINTEGER_ELEMENT,
                               (ArrayList<ElementType>) null);
      level2.children.add(level3);
      ...
      level3 = new ElementType("TrackCodecName",
                               (short) 3,
                               TrackCodecName_Id,
                               ElementType.STRING_ELEMENT, // TODO: this is supposed to be UTF-8 element
                               (ArrayList<ElementType>) null);
      level2.children.add(level3);

      level3 = new ElementType("TrackCodecDecodeAll",
                               (short) 3,
                               TrackCodecDecodeAll_Id,
                               ElementType.UINTEGER_ELEMENT,
                               (ArrayList<ElementType>) null);
      level2.children.add(level3);

      level3 = new ElementType("TrackSeekPreroll",
                               (short) 3,
                               TrackSeekPreroll_Id,
                               ElementType.UINTEGER_ELEMENT,
                               (ArrayList<ElementType>) null);
   ...
   */
  @Override
  public Element createElement(final ElementType type)
  {
    Element elem = null;
   ...
   */
  @Override
  public Element createElement(final byte[] type)
  {
